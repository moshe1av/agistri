...
const musicSource = 'assets/Relaxing Greek Traditional Music _ 1-Hour Calm Instrumental Playlist_2756_2792.mp3';
...
fs.copyFileSync(musicSource, `${out.substring(0, out.lastIndexOf('/'))}/music.mp3`);
